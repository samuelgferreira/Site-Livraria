...
<body>
    ...
    <div class="container">
                ...
                foreach ($usuario as $reg)
				{
						...
						echo "</div>";
						echo "<div style='background-image: url(http://127.0.0.1/site/img/fundo.png);' class='col-lg-8 text-left'>";
						echo "<br><p>Nome: ".$reg->getNome()."</p><br/>";
						echo "<p>Autor: ".$reg->getAutor()."</p><br/>";
						echo"<p>Categoria: ".$reg->getCategoria()."</p><br>";
						echo "<p>Descrição: ".$reg->getDescricao()."</p><br>";
						echo "</div>";
				}
               ?>
    </div>
