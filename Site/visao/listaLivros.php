...
<head>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
					...
					<li>
                        <a href="livro.php?func=menus">Alterar Menus</a>
                    </li>
					<li>
	...
	<div style="background-image: url(http://127.0.0.1/site/img/fundo.png);" class="container">
	<br>
			<h5>&nbsp Nome &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
			Autor &nbsp &nbsp &nbsp &nbsp
			Categoria</h5>
            <table  width="50%">
                <?php
                foreach ($lista as $reg){
                    ...
                    echo"<td>".$reg->getAutor()."</td>";
					echo"<td>".$reg->getCategoria()."</td>";
                    echo"<td>
                    <a href='livro.php?func=alterar&id=".$reg->getId()."'>
                    Alterar
                    </a></td>";
					echo "<td><a onclick=\"javascript: return confirm('Tem certeza que deseja deletar esse registro' );\"
					href='livro.php?func=excluir&id=".$reg->getId()."' >
					Excluir</a></td>"; //use double quotes for js inside php!
                }
                ?>
            </table>
			<br>
