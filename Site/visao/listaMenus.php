        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
					...
					<li>
                        <a href="livro.php?func=cadmenu">Adicionar Menu</a>
                    </li>
					<li>
	...
	<br>
            <table width="50%" border="0px">
                ...
                foreach ($lista as $reg){
					...
					echo"<td>
                    <a href='livro.php?func=alterarmenu&id=".$reg->getId()."'>
                    Alterar
                    </a></td>";
					echo "<td><a onclick=\"javascript: return confirm('Tem certeza que deseja deletar esse registro' );\"
					href='livro.php?func=excluirmenu&id=".$reg->getId()."' >
					Excluir</a></tr><td>"; //use double quotes for js inside php!
